...
async def to_code(config):
    ...
    t_cur = cg.new_Pvariable(cg.allocate_id(sensor.Sensor), sensor.Sensor())
    ...
    t_pipe = cg.new_Pvariable(cg.allocate_id(sensor.Sensor), sensor.Sensor())
    ...
    quiet_sw = cg.new_Pvariable(cg.allocate_id(ACHISwitch), ACHISwitch())
    ...
    turbo_sw = cg.new_Pvariable(cg.allocate_id(ACHISwitch), ACHISwitch())
    ...
    led_sw = cg.new_Pvariable(cg.allocate_id(ACHISwitch), ACHISwitch())
    ...
    eco_sw = cg.new_Pvariable(cg.allocate_id(ACHISwitch), ACHISwitch())
    ...
    ud_sw = cg.new_Pvariable(cg.allocate_id(ACHISwitch), ACHISwitch())
    ...
    lr_sw = cg.new_Pvariable(cg.allocate_id(ACHISwitch), ACHISwitch())
    ...
    # --------- Number (setpoint) ----------
    temp_num = cg.new_Pvariable(cg.allocate_id(ACHINumber), ACHINumber())
    ...
    # --------- Selects ----------
    mode_sel = cg.new_Pvariable(cg.allocate_id(ACHISelect), ACHISelect())
    ...
    wind_sel = cg.new_Pvariable(cg.allocate_id(ACHISelect), ACHISelect())
    ...
    sleep_sel = cg.new_Pvariable(cg.allocate_id(ACHISelect), ACHISelect())
